...
import com.rigil.meetingapp.MRUtil;
...
public class MeetingReportServlet extends BaseServlet {
  ...
  protected void doGet(HttpServletRequest req, HttpServletResponse resp)
    ...
    if (searchFor != null) {
    	...
    	if (e != null) {
	        ...
	        result.add(e);
	        out.println(MRUtil.writeReportEntityJSON(e, "Agendaitem", "Note", "Actionitem", "Attachment", "agimeetingID", "nparentID",	"aciparentID", "aparentID"));
        }
    	else {
    		out.println("[]");    		
		}
